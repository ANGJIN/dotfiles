...
[Copied from eieioxyz's Repository](https://github.com/eieioxyz/Beyond-Dotfiles-in-100-Seconds)  
to learn managing dotfiles
...
```zsh
# Use SSH (if set up)...
git clone git@github.com:ANGJIN/dotfiles.git ~/.dotfiles

# ...or use HTTPS and switch remotes later.
git clone https://github.com/ANGJIN/dotfiles.git ~/.dotfiles
```
